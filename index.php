    ...
    <div class="container-fluid my-5">
        <div class="row col-10 mx-auto gap-3">
            <?php foreach ($productsArray as $product) : ?>
                <div class="col-3 px-0 flip-card" style="height: 420px;">
                    <div class="flip-card-inner">
                        <div class="flip-card-front card">
                            <figure class="figure position-relative " style="height: 80%; width:100%;">
                                <img src="<?= $product->img ?>" class="img-fluid object-fit-cover" alt="<?= $product->titolo . ' copertina' ?>" style="border-radius: 0.3rem 0.3rem 0 0">
                        ...
                        <div class="flip-card-back card">
                            <div class="card-body">
                                <h4 class="mt-5">Informazioni aggiuntive:</h4>
                                <h5 class="card-title"><?= $product->materiale ?? $product->scadenza ?? $product->eta ?></h5>
                                <h6 class="card-text">
                                    <?= $product->taglia ?? $product->calorie ?? ($product instanceof Toy ? $product->hasBatteries() : '') ?>
                                </h6>
                            </div>
                        </div>
                    </div>
